...
## Configuring search operator to be AND by default - ANW-427 BUT NOTE LIKELY ONLY IN STAFF INTERFACE!
...
AppConfig[:plugins] = ['local', 'lcnaf', 'print', 'aspace-import-excel']
#
...
## NB: LEAVING THIS BLANK FOR NOW, BUT CONSIDER CHANGING TO URL OF UHML FEEDBACK FORM
