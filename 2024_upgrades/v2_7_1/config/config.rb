...
AppConfig[:plugins] = ['local', 'lcnaf', 'print', 'aspace-import-excel', 'langscript_batchupdate', 'aspace-reindexer']
...
AppConfig[:frontend_proxy_url] = "https://staffarchivesspacetest.ham.manoa.hawaii.edu/"
AppConfig[:public_proxy_url] = "https://archivesspacetest.ham.manoa.hawaii.edu/"
#
...
AppConfig[:reindex_on_startup] = true
